...
THEMES: List[Theme] = [
    Theme(
        "fed", "นโยบายการเงินสหรัฐฯ และทิศทางดอกเบี้ย", "ทิศทางดอกเบี้ยสหรัฐฯ", "นโยบายการเงิน",
        ("us-rates", "duration", "long-duration", "growth", "technology",
         "us-equity", "credit-spread", "property", "infrastructure"),
        "ธนาคารกลางสหรัฐฯ (เฟด) เป็นผู้กำหนดต้นทุนของเงินให้ทั้งโลก อัตราดอกเบี้ยนโยบาย และการคาดการณ์ของตลาดว่าดอกเบี้ยจะไปทางไหนต่อ เป็นตัวกำหนดอัตราผลตอบแทนพันธบัตรสหรัฐฯ อายุ 10 ปี",
        "อัตราผลตอบแทนนั้นคืออัตราคิดลดที่ใช้ประเมินมูลค่ากระแสเงินสดระยะยาวทุกรายการ เมื่อมันสูงขึ้น ราคาตราสารหนี้ลดลง และราคาหุ้นเติบโตที่มีมูลค่าอยู่ในอนาคตไกลก็ลดลงด้วย นี่คือเหตุผลที่ปี 2022 เจ็บหนัก ตราสารหนี้และหุ้นลงพร้อมกัน พอร์ต 60/40 จึงไม่มีที่หลบ",
    ...
    Theme(
        "bot", "นโยบาย ธปท. และเส้นอัตราผลตอบแทนในประเทศ", "ดอกเบี้ยนโยบายไทยและเส้นอัตราผลตอบแทน", "นโยบายการเงิน",
        ("thb-rates", "th-govt", "duration", "long-duration", "th-credit"),
        "ธนาคารแห่งประเทศไทยกำหนดอัตราดอกเบี้ยนโยบายในประเทศ ซึ่งเป็นหลักยึดของอัตราผลตอบแทนพันธบัตรรัฐบาลและหุ้นกู้ไทย",
        "กองทุนตราสารหนี้ไทยอายุยาวอาจขาดทุนหลายเปอร์เซ็นต์เมื่อเส้นอัตราผลตอบแทนขยับ 100 bp ซึ่งเป็นการขาดทุนเงินต้นจริง ไม่ใช่เพียงตัวเลขทางบัญชี ขณะที่กองทุนอายุสั้นแทบไม่ขยับ ช่องว่างระหว่างสองผลลัพธ์นี้คือการตัดสินใจที่สำคัญที่สุดในพอร์ตแบบระมัดระวังของไทย",
    ...
    Theme(
        "thb", "ค่าเงินบาทกับการลงทุนต่างประเทศที่ไม่ป้องกันความเสี่ยง", "ผลของค่าเงินบาทต่อสินทรัพย์ต่างประเทศ", "ค่าเงิน",
        ("fx-thb", "usd", "global-equity", "us-equity", "gold", "em-equity"),
        "กองทุนต่างประเทศของ K-Asset ส่วนใหญ่เสนอราคาเป็นเงินบาท แต่ถือสินทรัพย์ที่ตีราคาเป็นดอลลาร์ ยูโร หรือเยน บางกองป้องกันความเสี่ยงค่าเงินกลับมาเป็นบาท แต่หลายกองไม่ได้ทำ",
        "ในกองทุนที่ไม่ป้องกันความเสี่ยง ลูกค้าถือเดิมพันสองอย่างพร้อมกัน คือตัวสินทรัพย์ และค่าเงิน หุ้นสหรัฐฯ ขึ้น 10% พร้อมกับเงินบาทแข็งค่า 10% จะหักกลบกันเหลือเกือบศูนย์ในใบแจ้งยอดของลูกค้า ลูกค้ามักไม่รู้ตัวว่ากำลังถือสถานะค่าเงินอยู่ และนี่คือสาเหตุที่พบบ่อยที่สุดของคำถามว่าทำไมกองทุนไม่ขึ้นตามตลาด",
    ...
    Theme(
        "ai", "วัฏจักรการลงทุน AI และเซมิคอนดักเตอร์", "วัฏจักรการลงทุน AI และเซมิคอนดักเตอร์", "ธีมการลงทุน",
        ("technology", "semiconductor", "ai", "growth", "us-equity",
         "concentrated", "asia-equity"),
        "การลงทุนในศูนย์ข้อมูล AI กลายเป็นปัจจัยเดียวที่มีอิทธิพลต่อกำไรของหุ้นทั่วโลกมากที่สุด และกระจุกตัวอยู่ในบริษัทขนาดใหญ่มากเพียงไม่กี่แห่ง",
        "กองทุนดัชนีหุ้นทั่วโลกในวันนี้มีน้ำหนักกลุ่มเทคโนโลยีสูงกว่าเมื่อห้าปีก่อนมาก ลูกค้าที่คิดว่าตนกระจายความเสี่ยงแล้ว จึงอาจถือสถานะ AI แบบกระจุกตัวอยู่ การเพิ่มกองทุนเทคโนโลยีเฉพาะทางเข้าไปอีก เท่ากับซ้อนเดิมพันเดิมสองชั้น",
    ...
    Theme(
        "china", "นโยบายจีน มาตรการกระตุ้น และปัญหาอสังหาริมทรัพย์", "ความเสี่ยงเชิงนโยบายของจีน", "การเติบโต",
        ("china", "asia-equity", "em-equity", "technology", "commodities"),
        "หุ้นจีนถูกขับเคลื่อนด้วยความเต็มใจของรัฐในการกระตุ้นเศรษฐกิจและท่าทีต่อภาคเอกชน มากกว่าจะเป็นกำไรของบริษัท",
        "จีนจึงเป็นสถานะเชิงนโยบาย ไม่ใช่สถานะเชิงมูลค่า ของถูกอาจถูกอยู่อย่างนั้นได้หลายปี อย่างที่เห็นในปี 2021-2022 การกำหนดขนาดสถานะจึงสำคัญกว่าราคาที่เข้าซื้อ และการถือกองทุนหุ้นจีนประเทศเดียว 50% คือการเดิมพันบนการตัดสินใจของรัฐบาลเดียว",
    ...
    Theme(
        "gold", "ทองคำ อัตราดอกเบี้ยแท้จริง และความต้องการของธนาคารกลาง", "วัฏจักรทองคำ", "สินค้าโภคภัณฑ์",
        ("gold", "safe-haven", "real-assets", "usd"),
        "ทองคำไม่มีกระแสเงินสด ราคาจึงถูกขับเคลื่อนด้วยอัตราดอกเบี้ยแท้จริง ค่าเงินดอลลาร์ และการซื้อของภาครัฐ",
        "ทองคำเป็นเครื่องกระจายความเสี่ยงที่แท้จริง แต่ไม่ใช่สินทรัพย์ความเสี่ยงต่ำ ทองคำเคยขาดทุนเกิน 20% หลายครั้ง และอาจลงพร้อมหุ้นในภาวะขาดสภาพคล่อง อย่างที่เกิดในเดือนมีนาคม 2020 จึงควรมองเป็นส่วนเสริมที่ผันผวน ไม่ใช่ของแทนตราสารหนี้",
    ...
    Theme(
        "trade", "ภาษีนำเข้า นโยบายการค้า และห่วงโซ่อุปทาน", "นโยบายภาษีนำเข้าและห่วงโซ่อุปทาน", "ภูมิรัฐศาสตร์",
        ("us-equity", "china", "asia-equity", "technology", "asean", "vietnam",
         "em-equity", "semiconductor"),
        "นโยบายภาษีนำเข้าและการควบคุมการส่งออกเป็นตัวกำหนดว่าสินค้าจะถูกผลิตที่ไหน และใครจะได้ส่วนต่างกำไร",
        "ไทยและเวียดนามอยู่ในเส้นทางการย้ายฐานการผลิตโดยตรง บางครั้งเป็นผู้ได้ประโยชน์ บางครั้งเป็นผู้เสียหายพลอยได้ ความเสี่ยงนี้ไม่ได้จำกัดอยู่แค่กองทุนที่มีคำว่าเอเชียในชื่อ กองทุนเทคโนโลยีทั่วโลกก็ถือห่วงโซ่อุปทานเดียวกัน",
    ...
    Theme(
        "thai", "การเติบโตในประเทศ การเมือง และกระแสเงินลงทุนไทย", "การเติบโตและกระแสเงินในไทย", "การเติบโต",
        ("th-equity", "th-value", "th-growth", "financials", "index",
         "small-cap", "concentrated"),
        "SET ถูกขับเคลื่อนด้วยการท่องเที่ยว การบริโภคในประเทศ เสถียรภาพทางการเมือง และกระแสเงินของนักลงทุนต่างชาติ โดยเรียงตามลำดับความสำคัญคร่าว ๆ นี้",
        "ตลาดหุ้นไทยมีขนาดเล็กและถูกขับเคลื่อนด้วยกระแสเงิน แรงขายของต่างชาติจึงสามารถครอบงำปัจจัยพื้นฐานได้เป็นเวลานาน ลูกค้าที่มีสัดส่วนหุ้นทั้งหมดเป็นหุ้นไทย จึงเผชิญความเสี่ยงจากตลาดเดียวที่เล็ก สภาพคล่องต่ำ และอ่อนไหวต่อกระแสเงิน ซึ่งคือกับดักการกระจุกตัวในประเทศ",
    ...
    Theme(
        "credit", "ส่วนต่างอัตราผลตอบแทนและวัฏจักรหุ้นกู้", "วัฏจักรสินเชื่อ", "สินเชื่อ",
        ("credit-spread", "th-credit", "asia-credit", "private-credit",
         "illiquid", "financials"),
        "หุ้นกู้ให้ผลตอบแทนสูงกว่าพันธบัตรรัฐบาล เพราะผู้ออกอาจไม่ชำระหนี้ ผลตอบแทนส่วนเกินนั้นเรียกว่า credit spread",
        "spread จะกว้างขึ้นเร็วที่สุดในจังหวะเดียวกับที่หุ้นปรับลง กองทุนหุ้นกู้จึงป้องกันความเสี่ยงในภาวะวิกฤตได้น้อยกว่ากองทุนพันธบัตรรัฐบาล ในประเทศไทยเรื่องนี้สำคัญถึงระดับผู้ออกตราสารรายตัว เพราะการผิดนัดชำระหนี้เพียงรายเดียวก็ทำให้ NAV ของกองทุนเปลี่ยนได้",
    ...
    Theme(
        "energy", "ราคาพลังงานและการส่งผ่านไปสู่เงินเฟ้อ", "ราคาพลังงาน", "สินค้าโภคภัณฑ์",
        ("oil", "energy", "commodities", "agriculture"),
        "น้ำมันเป็นทั้งต้นทุนของระบบเศรษฐกิจ และเป็นรายได้ของหุ้นกลุ่มใหญ่ในดัชนีไทย",
        "ไทยเป็นผู้นำเข้าพลังงานสุทธิ ราคาน้ำมันที่พุ่งขึ้นต่อเนื่องจึงเป็นภาษีต่อการเติบโตของไทย แม้จะดันหุ้นกลุ่มพลังงานใน SET ขึ้นก็ตาม กองทุนพลังงานจึงเป็นเครื่องป้องกันความเสี่ยงเฉพาะสถานการณ์เงินเฟ้อ ไม่ใช่เครื่องกระจายความเสี่ยงแบบใช้ได้ทุกกรณี",
    ...
    Theme(
        "japan", "ญี่ปุ่น ค่าเงินเยน และ carry trade", "yen carry trade", "ค่าเงิน",
        ("jp-equity", "jpy", "global-equity", "growth", "technology"),
        "หลายทศวรรษที่ผ่านมา เงินเยนเป็นแหล่งกู้เพื่อไปลงทุนที่อื่นแบบใช้เลเวอเรจ เพราะดอกเบี้ยญี่ปุ่นใกล้ศูนย์ เมื่อธนาคารกลางญี่ปุ่นเริ่มปรับนโยบายเข้าสู่ภาวะปกติ แหล่งเงินนั้นก็ถูกถอนออก",
        "การคลายสถานะในเดือนสิงหาคม 2024 แสดงให้เห็นว่าผลกระทบส่งผ่านเร็วเพียงใด สถานะ momentum ที่หนาแน่นทั่วโลกปรับลงเป็นเลขสองหลักภายในสามวันทำการ โดยที่ปัจจัยพื้นฐานของบริษัทไม่ได้เปลี่ยน นี่คือความเสี่ยงด้านสภาพคล่องที่ปรากฏขึ้นแม้ในกองทุนที่ไม่มีหุ้นญี่ปุ่นเลย",
    ...
    Theme(
        "frontier", "อินเดีย เวียดนาม และการเข้าถึงตลาดชายขอบ", "การเข้าถึงตลาดชายขอบ", "การเติบโต",
        ("india", "vietnam", "frontier", "em-equity", "asean", "small-cap"),
        "อินเดียและเวียดนามมีเรื่องราวการเติบโตจากโครงสร้างประชากรและภาคการผลิต แต่มีสภาพคล่องต่ำกว่าตลาดพัฒนาแล้วอย่างมีนัยสำคัญ",
        "ตลาดชายขอบอาจเคลื่อนไหวรุนแรงเพียงเพราะกระแสเงิน และกฎการเข้าถึงตลาดอาจเปลี่ยนได้ โอกาสรับผลตอบแทนมีจริง แต่การกำหนดขนาดสถานะควรสะท้อนว่าลูกค้าอาจขายออกในราคาที่เป็นธรรมไม่ได้อย่างรวดเร็ว",
