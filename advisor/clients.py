...
RISK_PROFILES: Dict[int, RiskProfile] = {
    ...
    7: RiskProfile(
        ...
        description="เน้นการเติบโต ลงทุนกองทุน Sector และธีมได้ "
    ...
    8: RiskProfile(
        ...
        description="มุ่งการเติบโตสูงสุด ตราสารทุนต้องเป็นสัดส่วนหลักของพอร์ต "
                    "และสินทรัพย์ทางเลือกมีบทบาทเป็น Satellite ขนาดใหญ่ได้",
    ),
}
...
CLIENTS: List[Client] = [
    ...
    Client(
        ...
        objective="แกนพอร์ตแบบสมดุล เสริมด้วย Thematic เพื่อเพิ่มโอกาสรับผลตอบแทน",
        horizon_years=10,
        notes="โครงสร้างเป็นแบบ core-satellite แต่ Satellite สองกองเป็นกองทุนรายกลุ่ม"
